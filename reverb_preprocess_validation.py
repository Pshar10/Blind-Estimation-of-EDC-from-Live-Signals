...
if __name__ == "__main__":
    ...
    rir_data_dir = "/home/prsh7458/Desktop/scratch4/validation_dataset/r3vival_location/combined"
    model_dir = "/home/prsh7458/work/R2D/edc-estimation/silero_vadsilero_vad"

    # output directories
    output_dir_speech = "/home/prsh7458/Desktop/scratch4/validation_dataset/r3vival_location/reverberant_speech_ilm" 
    output_dir_edc = "/home/prsh7458/Desktop/scratch4/validation_dataset/r3vival_location/EDC_ilm" 
    output_dir_noise = "/home/prsh7458/Desktop/scratch4/validation_dataset/r3vival_location/noise_ilm" 
    # output_dir_room = "/home/prsh7458/Desktop/scratch4/validation_dataset/r3vival_location/room_ilm" 
    ...
    for rir_index in range(num_rir_files):
        for speech_index in range(num_speech_files):
            # Process the files
            reverberant_speech, exist, rir_waveform, EDC_all, EDC_begin_End, noise, speech_sample_rate,var  = reverb_speech_processor.process(speech_index, rir_index,pos_bool=False)
            # print(var)
            ...
            # scipy.io.savemat(output_file_path_edc_true, {'EDC_begin_end': np.array(EDC_all)}, do_compression=True)  #changed to full EDC
